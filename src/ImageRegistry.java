...
public class ImageRegistry {
	...
	/**
	 * Este metodo se encarga de buscar la imagen solicitada y a�adirla al HashMap de imagenes. Si existe no la a�ade y solo la devuelve al usuario, 
	 * si no existe crea la imagen y la a�ade al HashMap, devolviendo la imagen como reusltado. 
	 * @param name
