...
public class Message {
	...
	public enum Keys {
		PLAYER_ID, PLAYER_NAME, CURRENT_BID, BID_WINNER, BID_AMOUNT, CARDS, GAME_SETTINGS, SUIT, PLAYED_CARD, HAND_SCORE, TEAM_ID, GAME_SET_WIN_ID, SCORE_DELTAS, IS_FIRST_BID, PLAYER_TURN_ID
